...
| `IS_TEMPLATE_REPO` | `autoupdatehtmltemplate` | CLAUDE.md (Template repo short-circuit, Template Repo Guard, Template Drift Checks step #0, Pre-Push Checklist item #4), `.github/workflows/auto-merge-claude.yml` (deploy job condition) |
